...
| [Current Connectors](current-connectors.md) | OpenAI Images, xAI Imagine, Reve, Google Gemini Image, Ideogram, Firecrawl, Jina, Reddit, DataForSEO, Ahrefs, WordPress, Ghost, sitemap, HTTP | Executable surface audit and provider documentation ledger. |
